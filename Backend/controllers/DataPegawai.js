...
// method untuk mencari data Employee berdasarkan ID
...
//  method untuk tambah data Employee
...
export const updateDataPegawai = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ msg: "Data Employee Updated" });
  } catch (error) {
    res.status(400).json({ msg: error.message });
  }
};

// method untuk delete data Employee
export const deleteDataPegawai = async (req, res) => {
  ...
  if (!pegawai)
    return res.status(404).json({ msg: "Data Employee tidak ditemukan" });
  try {
    ...
    res.status(200).json({ msg: "Data Employee Deleted" });
  } catch (error) {
    res.status(400).json({ msg: error.message });
  }
};
