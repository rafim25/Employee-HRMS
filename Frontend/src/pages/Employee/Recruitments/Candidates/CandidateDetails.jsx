...
import {
  FaDownload, FaEnvelope, FaPhone, FaBuilding, FaMapMarkerAlt,
  FaMoneyBillWave, FaClock, FaArrowLeft, FaUserTie, FaMapMarked,
  FaFileAlt, FaInfoCircle, FaUserFriends, FaCalendarAlt, FaBriefcase,
  FaFileUpload, FaUserCircle
} from 'react-icons/fa';
...
const CandidateDetails = () => {
  ...
  const renderStatusBadge = (status) => {
    ...
    return (
      <span className={`px-3 py-1 rounded-full text-sm font-medium ${statusColors[normalizedStatus] || 'bg-gray-100 text-gray-500'}`}>
        {status.toUpperCase()}
      </span>
    );
  };
  ...
  return (
    <DefaultLayoutEmployee>
      <BreadcrumbPegawai pageName="Candidate Details" backButton={true} icon={FaUser} />
              ...
              <div className="mb-4 flex flex-col items-center">
                <div className="relative mb-4">
                  {candidate.image_url ? (
                    ...
                    <FaUserCircle className="w-32 h-32 text-gray-500 dark:text-gray-400" />
                  )}
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        {candidate.application_status || candidate.status ?
                          renderStatusBadge(candidate.application_status || candidate.status) :
                          <span className="text-gray-500">Status not set</span>
                        }
                      </div>
                    </div>
                    <div>
